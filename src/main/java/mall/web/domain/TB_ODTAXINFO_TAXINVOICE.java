...
@Alias("tb_odtaxinfo_taxinvoice")
@XmlRootElement(name = "tb_odtaxinfo_taxinvoice")
public class TB_ODTAXINFO_TAXINVOICE extends DefaultDomain {
	...
	//TB_ODTAXINFO_TAXINVOICE table info
	private String ID = "";
	...
	public String toString() {
		return "TB_ODTAXINFO_TAXINVOICE [ORDER_DTNUM=" + ORDER_DTNUM + ", ORDER_NUM=" + ORDER_NUM + ", PD_CODE="
				+ PD_CODE + ", PD_NAME=" + PD_NAME + ", PD_PRICE=" + PD_PRICE + ", PDDC_GUBN=" + PDDC_GUBN
				+ ", PDDC_VAL=" + PDDC_VAL + ", ORDER_QTY=" + ORDER_QTY + ", ORDER_AMT=" + ORDER_AMT + ", DLVY_AMT="
				+ DLVY_AMT + ", USE_SVMN=" + USE_SVMN + ", OCCUR_SVMN=" + OCCUR_SVMN + ", ORDER_CON=" + ORDER_CON
				+ ", PAY_METD=" + PAY_METD + ", PAY_MDKY=" + PAY_MDKY + ", DLVY_CON=" + DLVY_CON + ", DLVY_COM="
				+ DLVY_COM + ", DLVY_TDN=" + DLVY_TDN + ", CNCL_CON=" + CNCL_CON + ", RFND_CON=" + RFND_CON
				+ ", REGP_ID=" + REGP_ID + ", MODP_ID=" + MODP_ID + ", DEL_YN=" + DEL_YN + ", PAY_DATE=" + PAY_DATE
				+ ", PD_CUT_SEQ=" + PD_CUT_SEQ + ", OPTION_CODE=" + OPTION_CODE + ", BOX_PDDC_GUBN=" + BOX_PDDC_GUBN
				+ ", BOX_PDDC_VAL=" + BOX_PDDC_VAL + ", INPUT_CNT=" + INPUT_CNT + ", MBDC_VAL=" + MBDC_VAL
				+ ", SUPR_ID=" + SUPR_ID + ", OPTION1_NAME=" + OPTION1_NAME + ", OPTION1_VALUE=" + OPTION1_VALUE
				+ ", OPTION2_NAME=" + OPTION2_NAME + ", OPTION2_VALUE=" + OPTION2_VALUE + ", LINK_MODP_DATE="
				+ LINK_MODP_DATE + ", LINK_ORDER_KEY=" + LINK_ORDER_KEY + ", DLVY_TDN_MODP_DATE=" + DLVY_TDN_MODP_DATE
				+ ", OPTION3_NAME=" + OPTION3_NAME + ", OPTION3_VALUE=" + OPTION3_VALUE + ", CNCL_MSG=" + CNCL_MSG
				+ ", RFND_AMT=" + RFND_AMT + ", RFND_DLVY_AMT=" + RFND_DLVY_AMT + ", RFND_DLVY_TDN=" + RFND_DLVY_TDN
				+ ", SETPD_CODE=" + SETPD_CODE + ", IMSI_DLVY_AMT=" + IMSI_DLVY_AMT + ", ID=" + ID
				+ ", INVOICEECORPNUM=" + INVOICEECORPNUM + ", INVOICEECORPNAME=" + INVOICEECORPNAME
				+ ", INVOICEECEONAME=" + INVOICEECEONAME + ", POSTALCODE=" + POSTALCODE + ", INVOICEEADDR="
				+ INVOICEEADDR + ", INVOICEEBIZTYPE=" + INVOICEEBIZTYPE + ", INVOICEEBIZCLASS=" + INVOICEEBIZCLASS
				+ ", INVOICEECONTACTNAME=" + INVOICEECONTACTNAME + ", INVOICEEEMAIL=" + INVOICEEEMAIL + ", INVOICEETEL="
				+ INVOICEETEL + ", PAYMENT=" + PAYMENT + ", INVOICEEE_REG_DTM=" + INVOICEEE_REG_DTM + ", writedatemon="
				+ writedatemon + ", writedateday=" + writedateday + "]";
	}
