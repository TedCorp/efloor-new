...
public interface ProductRcmdMgrMapper {
	...
	//############### 리테일관련 함수 ###############
	public int grpRtCnt(Object obj) throws Exception;
	public List<?> retailExcelList(Object obj) throws Exception;
	public int countRetail(Object obj) throws Exception;
	public List<?> retailList(Object obj) throws Exception;
	public List<?> retailExcel(Object obj) throws Exception;
	//############### 행사관련 함수 ###############	
	//public List<?> eventExcelList(Object obj) throws Exception;
	//public int grpEvCnt(Object obj) throws Exception;
	//public int excelUpload2(Object obj) throws Exception;
}
