...
public class PageFooterTag extends BodyTagSupport
{
    ...
    private String gEntcago;	//진입카테고리
	...
	public int doAfterBody()throws JspException {
        try
        {
            ...
            bodyText = "<div class='paging_new'><ul>" + bodyText;
     ...
     * @throws Exception
     */
    private String getFirst(HttpServletRequest req) throws Exception {
        StringBuffer sb = new StringBuffer(1024);
        if(gTotalPage != 0)
        {
            sb.append("<li class=\"start\"><a href=\"" + url + "?pageNum=1&rowCnt=").append(rowCount).append(gSearchStr).append("\" ><i class=\"ic\"></i></a></li>");
        }
        return sb.toString();
    }
        ...
        throws Exception
    {
        ...
        {
            StringBuffer sb = new StringBuffer(1024);
            sb.append("<li class=\"prev\"><a class=\"prev\" href=\"" + url + "?");
        ...
        throws Exception
    {
        ...
        if(pageNum <= gTotalPage)
        {
            ...
            sb.append("<li class=\"next\"><a  href=\"" + url + "?");
        ...
        throws Exception
    {
        ...
        if(gTotalPage != 0)
        {
            sb.append("<li class=\"end\"><a href=\"" + url + "?");
     ...
     * @param req HttpServletRequest
     */
    private void getEntcago(HttpServletRequest req)
    {
    	 	
    	String entcago = req.getParameter("entcago") != null ? req.getParameter("entcago") : "";
    	
    	gEntcago = "&entcago=" + entcago;
    }
