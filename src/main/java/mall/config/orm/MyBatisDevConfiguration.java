...
@PropertySource(value={"classpath:/jdbc.dev.properties"}, ignoreResourceNotFound=true)
@Profile("dev")
public class MyBatisDevConfiguration implements InitializingBean {
	...
	public SqlSessionFactoryBean sqlSessionFactoryBean(DataSource dataSource, ApplicationContext applicationContext) throws Exception {
		...
		sqlSessionFactoryBean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:mall/sql/**/*.xml"));
