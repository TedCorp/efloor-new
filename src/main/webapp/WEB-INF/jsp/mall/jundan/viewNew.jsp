			...
			<div id="sct">
				...
				<div class="panel panel-default" style="background-color: #dff0d8">
				  <div class="panel-body">
				      ...
				      <!-- info row -->
				      <div class="row">
				        <div class="col-sm-5" style="font-size:1.2em;">
				            <h4 class="text-primary"><strong>행사안내</strong></h4>
				            행사점포 : <strong class="text-success">농.수.축산물센터(유성점)</strong><br>
				            행사기간 : <strong class="text-success">10월 18일(화)~10월 22일(토), 5일간</strong><br>
				...
				<c:if test="${ !empty(rtnProdList) }">
					<div class="panel panel-primary">
						<div class="panel-heading">
							행사상품
							<button type="button" class="btn btn-sm btn-default pull-right" id="btnOrdName" style="margin-right: 0px;margin-top: -5px;">상품명순</button>
							<button type="button" class="btn btn-sm btn-default pull-right" id="btnOrdPrice" style="margin-right: 5px;margin-top: -5px;">가격순</button>
						</div>
						<div class="panel-body" style="background-color: #ECF0F5;">
							...
							<c:forEach var="ent" items="${ rtnProdList }" varStatus="status">
								<li class="sct_li" title="<c:out value="${ ent.PD_DESC }" escapeXml="true"/>" style="background-color: #fff;">
									<div class="sct_img">
										...
										<div style="top:0px;left:10px;position:absolute;">
											<span class="label label-danger">${ent.PD_CONS }</span>
										</div>
										</c:if>
									</div>
									<div class="sct_txt">
