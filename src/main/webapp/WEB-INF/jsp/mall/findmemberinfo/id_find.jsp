...
<div id="mb_login" class="mbskin">
    ...
    <div id="maint" class="main-tab" style="height:310px ">
		<!-- 탭 헤드 -->
		...
		<div class="tab-content tab-con-main">
			<div role="tabpanel" class="tab-pane active" id="home" style="margin-left:10px; margin-right:10px; "> <!-- class ta_c뺌 -->
				...
				<!-- 탭 : 개인 -->		
				<div id = "private">				
				    <form name="flogin" action="${contextPath }/findmemberinfo/result" onsubmit="return flogin_submit(this);" method="post">
					    <input type="hidden" name="url" value="">
					    <input type="hidden" name="rtnUrl" value='<%= request.getHeader("referer") %>'>
						<label class="login_id">개인</label>
						
					    <fieldset id="login_fs" style="height:120px">    
					    	
					        <label for="login_id" id = "a1">회원이름<strong class="sound_only"> 필수</strong></label>    
					        <input type="text" name="MEMB_NAME" id="MEMB_NAME" required class="frm_input required" size="20" maxLength="20">
					        
					        
					        <label for="login_pw" id = "a2">휴대폰번호<strong class="sound_only"> 필수</strong></label>
					        ...
					        <!-- <input type="text" name="MEMB_CPON" id="MEMB_CPON" required class="frm_input required" size="20" maxLength="20"> -->					          
			...
			<div role="tabpanel" class="tab-pane" id="profile"  style="margin-left:10px; margin-right:10px;"> <!-- class ta_c뺌 -->
				<div id = "business">
				    <form name="flogin2" action="${contextPath }/findmemberinfo/result" onsubmit="return flogin_submit(this);" method="post">
					    <input type="hidden" name="url" value="">
					    <input type="hidden" name="rtnUrl" value='<%= request.getHeader("referer") %>'>
					    ...
					    <fieldset id="login_fs" style="height:120px">    
					        ...
					        <label for="login_id" id="a3">사업자번호<strong class="sound_only"> 필수</strong></label>
