...
<div class="btn_confirm">
	...
	<c:if test="${tb_odinfoxm.ORDER_CON eq 'ORDER_CON_01'}">
		<a onclick="javascript:;" id="btnPayCall" class="btn btn-sm btn-success pull-right" style="margin-right:5px;height:48px;padding-top: 14px;">신용카드</a>
      	<a onclick="javascript:;" id="btnPay2Call" class="btn btn-sm btn-success pull-right" style="margin-right:5px;height:48px;">실시간 계좌이체</a>
...
<div>	
	<!-- <img style="margin-left:40px;"src="https://www.cjfls.co.kr/resources/img/board/faq_no_28.png"> -->
	<img style="margin-left:40px;"src="http://www.cjfls.co.kr/resources/img/order/dlvy_info_201905.png">
</div>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
            ...
            <form role="form">            	
            	<img src="${contextPath}/resources/img/order/bank_info3.jpg" style="width:100%;height:auto;">
            </form>
			</div>
			<div class="modal-footer">
...
function fnPayClose() {
	...
	window.location.href = "<%= request.getContextPath() %>/order/view/${tb_odinfoxm.ORDER_NUM }";
}
