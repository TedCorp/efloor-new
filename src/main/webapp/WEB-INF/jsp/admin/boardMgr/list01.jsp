...
<c:set var="strActionUrl" value="${contextPath }/adm/boardMgr/type01/${obj.BRD_GUBN}" />
		...
		<div class="box-body">
			<table class="table table-bordered">
				...
				<c:forEach items="${obj.list }" var="list" varStatus="loop">
					<tr>
						<td>${loop.count }</td>
						<td><a href="${contextPath}/adm/boardMgr/type01/${list.BRD_GUBN }/${list.BRD_NUM }">${list.BRD_SBJT }</a></td>
						<td>${list.WRTR_NM }</td>
						<td>${list.WRT_DTM }</td>
