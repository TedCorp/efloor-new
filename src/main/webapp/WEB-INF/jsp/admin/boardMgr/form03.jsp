...
<%-- <c:set var="strActionUrl" value="${contextPath }/adm/boardMgr/type02/${tb_pdbordxm.BRD_GUBN }/${tb_pdbordxm.BRD_NUM }" /> --%>
<c:set var="strActionUrl" value="${contextPath }/adm/boardMgr/type03/${tb_pdbordxm.BRD_GUBN }/${tb_pdbordxm.BRD_NUM }" />
...
<section class="content">
	<!-- Horizontal Form -->
			...
			<div class="box-footer" >
				<a href="${contextPath}/adm/boardMgr/type03/${tb_pdbordxm.BRD_GUBN}" class="btn btn-default pull-right">리스트</a>
