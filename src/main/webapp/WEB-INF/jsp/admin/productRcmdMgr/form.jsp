...
<section class="content">
		...
		<div class="box box-info">
			...
			<div class="box-body">
				<div class="form-group">
					<label for="GRP_CD" class="col-sm-2 control-label required">그룹코드</label>
					<div class="col-sm-10">
						<c:choose>
				...
				<div class="form-group">
					<label for="GRP_NM" class="col-sm-2 control-label required">그룹명</label>
					<div class="col-sm-7">
						<input class="form-control input-sm" type="text" id="GRP_NM" name="GRP_NM" value="${tb_pdrcmdxm.GRP_NM }" maxlength="50"/>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<label for="USE_YN" class="col-sm-1 control-label required">사용여부</label>
					<div class="col-sm-3">
						<p class="form-control-static">
			                <jsp:include page="${contextPath }/common/comCodForm">
								<jsp:param name="COMM_CODE" value="COMM_YN" />
								<jsp:param name="name" value="USE_YN" />
								<jsp:param name="value" value="${ tb_pdrcmdxm.USE_YN }" />
								<jsp:param name="type" value="radio" />
								<jsp:param name="top" value="선택" />
							</jsp:include>
						</p>
						<%-- <select name="USE_YN" id="USE_YN" class="form-control select2">
							<option value="Y" ${tb_pdrcmdxm.USE_YN eq 'Y' ? 'selected=selected':''}>사용</option>
							<option value="N" ${tb_pdrcmdxm.USE_YN eq 'N' ? 'selected=selected':''}>미사용</option>
						</select> --%>
					</div>
				</div>
				
				<div class="form-group">
					<label for="RCMD_GUBN" class="col-sm-2 control-label required">상품그룹구분</label>
					<div class="col-sm-3">
						<p class="form-control-static">
			                <jsp:include page="${contextPath }/common/comCodForm">
					...
					<label for="ENTRY_ID" class="col-sm-2 control-label">진입카테고리코드</label>
					<div class="col-sm-3">
						<input class="form-control" type="text" id="ENTRY_ID" name="ENTRY_ID" value="${tb_pdrcmdxm.ENTRY_ID }" />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						...
						<button type="button" class="btn btn-info btn-sm btnExcelUpload">
							<i class="fa fa-file-excel-o"></i> 상품 엑셀 업로드 
						</button>
						<button type="button" class="btn btn-success btn-sm btnExcelDownload">
	...
	<div class="box-footer" >
		<a href="${contextPath}/adm/productRcmdMgr" class="btn btn-default pull-right"><i class="fa fa-list"></i> 목록</a></a>
		<a onclick="javascript:fn_save();" class="btn btn-info pull-right right-5"><i class="fa fa-save"></i> 저장</a>
		<c:if test="${ !empty tb_pdrcmdxm.GRP_CD }"><!-- 수정시 사용 -->
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">추천상품 엑셀 업로드</h4>
			</div>
