...
<section class="content">
	...
	<div class="box box-primary">
		...
		<!-- /.box-header -->
		<div class="box-body">
			<form class="form-horizontal" id="frm" method="get" action="${contextPath }/adm/productRcmdMgr/popupRetail">
				...
				<div class="box-body">
					...
					<div class="form-group">
						<div class="col-sm-12">							
							<label for="inputEmail3" class="col-sm-7 control-label">목록수</label>
							<div class="col-sm-2">
							...
							<div class="col-sm-3">
								<button type="button" class="btn btn-primary pull-right btnExcel" id="btnExcel" style="margin-left:5px;" >엑셀</button>
...
$(function(){
    ...
    $(".btnExcel").click(function() {    	
    	...
    	form.method = "post";
    	form.action = "${contextPath }/adm/productRcmdMgr/excelDown";
