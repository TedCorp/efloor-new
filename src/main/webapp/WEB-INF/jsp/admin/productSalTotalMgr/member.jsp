...
<c:set var="strActionUrl" value="${contextPath }/adm/productSalMemberMgr" />
...
<section class="content">
	...
	<div class="box box-primary">
		...
		<div class="box-body">
			<spform:form  class="form-horizontal" name="productSalTotalMgrForm" id="productSalTotalMgrForm" method="${strMethod }" action="${strActionUrl }">
				<!-- 검색조건 -->
						...
						<div class="col-sm-3">
							<div class="input-group">								
								...
								<span class="input-group-btn">
									<button type="button" class="btn btn-default" onclick="productModal()">상품검색</button>
		...
		<div class="box-body">
			<div class="box-body">
				<div class="form-group">
					...
					<div class="col-sm-9">
						<button type="button" class="btn btn-sm btnSort" id="ordCOM_NAME" sortGubun="MEMB_NAME" sortOdr="asc" sortName="회원명">회원명▼▲</button>
						<button type="button" class="btn btn-sm btnSort" id="ordCOM_NAME" sortGubun="COM_NAME" sortOdr="asc" sortName="상호명">상호명▼▲</button>
	...
	<div class="box box-default">
		<div class="box-header with-border">
			<h3 class="box-title">회원별 매출 목록</h3>
			<div class="box-tools">				
			...
			<table class="table table-bordered">
				...
				<tbody>
					<c:forEach items="${obj.list }" var="ent" varStatus="loop">
						<tr>
							<td> ${ ent.RNUM } </td>
							<td> ${ ent.COM_NAME ne null or ent.COM_NAME ne '' ? ent.COM_NAME : ent.MEMB_NAME } (${ ent.MEMB_NAME }) </td>
	                        <td> ${ ent.PD_CODE } </td>
	                        <td> ${ ent.PD_BARCD } </td>
							<td>
...
$(function() {
    ...
    $("#btnExcel").click(function() {
    	var strAction = "${contextPath }/adm/productSalMemberMgr/excel";
