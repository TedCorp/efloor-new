...
<section class="content">
	...
	<div class="box box-info">
		...
		<!-- form start -->
		<spform:form name="customerFrm" id="customerFrm" method="post" action="${contextPath }/customers" class="form-horizontal">
			<input type="hidden" name="SALESREPEMPLOYEENUMBER" value="1002" />
			<!-- box-body -->
			<div class="box-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="contactLastName" name="CONTACTLASTNAME" placeholder="Contact Last Name" required="required" />
					</div>
				</div>
				<div class="form-group">
					<label for="inputEmail3" class="col-sm-2 control-label">Contact First Name</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" id="contactFirstName" name="CONTACTFIRSTNAME" placeholder="Contact First Name" required="required" />
					</div>
				</div>
				<div class="form-group">
					<label for="inputEmail3" class="col-sm-2 control-label">Phone</label>
					<div class="col-sm-10">
						<input type="phone" class="form-control" id="phone" name="PHONE" placeholder="Phone Number" required="required" />
					</div>
				</div>
				<div class="form-group">
					<label for="inputEmail3" class="col-sm-2 control-label">Address Line1</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" id="addressLine1" name="ADDRESSLINE1" placeholder="AddressLine 1" required="required" />
					</div>
				</div>
				<div class="form-group">
					<label for="inputEmail3" class="col-sm-2 control-label">Address Line2</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" id="addressLine2" name="ADDRESSLINE2" placeholder="AddressLine 2">
					</div>
				</div>
				<div class="form-group">
