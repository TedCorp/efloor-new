...
<c:set var="strActionUrl" value="${contextPath }/adm/orderBakMgr" />
...
<section class="content">
	...
	<div class="box box-primary">
		<div class="box-header with-border">
			<h3 class="box-title">주문삭제내역 검색조건</h3>
	...
	<div class="box-header with-border">
		...
		<div class="box-tools">			
			...
			<button type="button" class="btn btn-danger btn-sm pull-right" onclick="javascript:deleteReturnOrd()">주문내역 복원</button>			
		</div>
	</div>
	<!-- 검색 박스 -->
	<div class="box box-primary">
			...
			<table class="table table-bordered">
				...
				<c:forEach items="${obj.list }" var="list" varStatus="loop">
					<tr>
						...
						<td style="text-align: center;vertical-align : middle;">
							<a href="${contextPath}/adm/orderBakMgr/form/${list.ORDER_NUM }">상세</a>
						</td>
					</tr>
				</c:forEach>
				</tbody>
...
<form name="dltRtnFrm" id="dltRtnFrm" method="post" action="${contextPath }/adm/orderBakMgr/deleteReturnOrdList" >
...
$(function() {
    ...
    $("#btnExcel").click(function() {    	
    	...
    	var strAction = "${contextPath }/adm/orderBakMgr/excelDown";
...
function deleteReturnOrd(){	
	...
	if(!confirm("'결제전' 또는 '주문취소' 상태의 주문만 복원됩니다. 진행하시겠습니까?"))return;
