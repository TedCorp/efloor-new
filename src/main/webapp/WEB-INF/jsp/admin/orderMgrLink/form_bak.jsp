	...
	<!-- Horizontal Form -->
		...
		<div class="box box-info">
									...
									<c:if test="${supr.SUPR_ID eq list.SUPR_ID }">
										...
										<tr>
											...
											<td>
												...
												%>
														<input type="text" name="ORDER_QTY" value="${list.ORDER_QTY }" class="form-control btnQty" 
															style="width:40%;margin-right:10px;display:inline" readonly/>
												<%
													}
												%>		
											...
											<c:if test="${supr.SUPR_ID eq login_supr_id }">
												<td>
													<input type="text" name="DTL_DLVY_TDN" value="${list.DLVY_TDN }" class="form-control btnQty" 
																style="width:100%;margin-right:10px;display:inline"/>
												</td>
											</c:if>
											<c:if test="${supr.SUPR_ID ne login_supr_id }">
												<td>
													<input type="text" name="DTL_DLVY_TDN" value="${list.DLVY_TDN }" class="form-control btnQty" 
																style="width:100%;margin-right:10px;display:inline" readonly/>
												</td>
			...
			<!-- /.box-header -->
				...
				<div class="box-body">
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" id="RECV_PERS" name="RECV_PERS" value="${tb_oddlaixm.RECV_PERS }" required="required" readonly />
						</div>
					</div><br/>
					<div class="form-group">
						...
						<div class="col-sm-10">
							<div class="form-group">
								<div class="col-sm-2">
									<input type="text" class="form-control" id="POST_NUM" name="POST_NUM" value="${tb_oddlaixm.POST_NUM }" required="required" readonly />
								</div>
								<div class="col-sm-3">
							...
							<div class="form-group">
								<div class="col-sm-12">
									<input type="text" class="form-control" id="BASC_ADDR" name="BASC_ADDR" value="${tb_oddlaixm.BASC_ADDR }" required="required" readonly />
									<input type="text" class="form-control" id="DTL_ADDR" name="DTL_ADDR" value="${tb_oddlaixm.DTL_ADDR }" required="required" readonly />
								</div>
							</div>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control" id="RECV_TELN" name="RECV_TELN" value="${tb_oddlaixm.RECV_TELN }" required="required" readonly />
						</div>
						<label for="inputEmail3" class="col-sm-2 control-label">휴대전화</label>
						<div class="col-sm-4">
							<input type="text" class="form-control" id="RECV_CPON" name="RECV_CPON" value="${tb_oddlaixm.RECV_CPON }" required="required" readonly />
						</div>
					</div><br/>
					<div class="form-group">
						...
						<input type="hidden" id="DLAR_TIME" name="DLAR_TIME" value="${tb_oddlaixm.DLAR_TIME }" /><!-- 출고/배송 시간 -->
						 ...
						 <c:if test = '${tb_oddlaixm.DLAR_GUBN!="DLAR_GUBN_05" }' >
							...
							<div class="col-sm-2">
								<select name="DLAR_TIME_CHK_02" id="DLAR_TIME_CHK_02" class="form-control input-sm" disabled="disabled" >
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<textarea rows="5" class="form-control" id="DLVY_MSG" name="DLVY_MSG" required="required" readonly>${tb_oddlaixm.DLVY_MSG }</textarea>
						</div>
					</div>
					<div class="form-group">
			...
			<div class="box-footer">
				<a href="${contextPath}/adm/orderMgrLink" class="btn btn-default pull-right">리스트</a>
...
<form name="updateQtyFrm" id="updateQtyFrm" method="post" action="${contextPath }/adm/orderMgrLink/orderQtyUpdate" >
...
$("#btnExcel").click(function() {
	...
	form.method = "get";
	form.action = "${contextPath }/adm/orderMgrLink/detailExcelDown";
