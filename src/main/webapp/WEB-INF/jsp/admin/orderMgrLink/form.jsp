	...
	<!-- Horizontal Form -->
		...
		<div class="box box-info">
								...
								<c:forEach items="${tb_odinfoxm.list }" var="list" varStatus="loop">
									<c:if test="${supr.SUPR_ID eq list.SUPR_ID }">
										...
										<tr>
											...
											<c:if test="${supr.SUPR_ID eq login_supr_id or supr.SUPR_ID eq 'C00001'}">
												<td>
													<input type="text" name="DTL_DLVY_TDN" value="${list.DLVY_TDN }" class="form-control btnQty" 
																style="width:100%;margin-right:10px;display:inline"/>
												</td>
											</c:if>
											<c:if test="${supr.SUPR_ID ne login_supr_id and supr.SUPR_ID ne 'C00001'}">
												<td>
													<input type="text" name="DTL_DLVY_TDN" value="${list.DLVY_TDN }" class="form-control btnQty" 
											...
											<td><input class="form-control btnQty" type="text" name="LOGIN_SUPR_ID" value="${list.LINK_ORDER_KEY }" style="width:100%;margin-right:10px;display:inline" readonly/></td>
			...
			<div class="box-footer">
				...
				<!-- <a onclick="javascript:fn_pgCancel();" class="btn btn-default  btn-warning">PG취소(결제취소)</a>
				<a onclick="javascript:fn_orderLink();" class="btn btn-default  btn-warning">연동상품 주문</a> -->
				<!-- <input type="button" class="btn btn-block btn-warning btn-xs" value="우편번호검색" > -->
			</div>
...
function fn_orderLink(){
	...
	$("#orderFrm").attr("action", "/adm/orderMgrLink/orderlinkapi");
	frm.submit();
...
function fn_pgCancel(){
	...
	$("#orderFrm").attr("action", "/adm/orderMgrLink/pgCancel");
	frm.submit();
